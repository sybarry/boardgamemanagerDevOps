 ...
 */
type BoardGameFormGroupInput = IBoardGame | PartialWithRequiredKeyOf<NewBoardGame>;

type BoardGameFormDefaults = Pick<NewBoardGame, 'id' | 'publishers' | 'categories'>;
...
export class BoardGameFormService {
  createBoardGameFormGroup(boardGame: BoardGameFormGroupInput = { id: null }): BoardGameFormGroup {
  ...
  resetForm(form: BoardGameFormGroup, boardGame: BoardGameFormGroupInput): void {
