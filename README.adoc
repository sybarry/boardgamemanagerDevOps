...
image::frontend/src/main/webapp/content/images/welcome.jpg[center=true]

_https://www.freepik.com/free-vector/board-games-people-isometric-set_6168565.htm#query=board%20games&position=2&from_view=keyword&track=ais"[Image by macrovector]_
