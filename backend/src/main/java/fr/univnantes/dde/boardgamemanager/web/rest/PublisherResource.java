...
import fr.univnantes.dde.boardgamemanager.repository.PublisherRepository;
...
/**
 * REST controller for managing {@link fr.univnantes.dde.boardgamemanager.domain.Publisher}.
 */
@RestController
...
public class PublisherResource {
  ...
  public ResponseEntity<Publisher> partialUpdatePublisher(
    ...
    log.debug(
      "REST request to partial update Publisher partially : {}, {}",
      id,
      publisher
    );
    if (publisher.getId() == null) {
