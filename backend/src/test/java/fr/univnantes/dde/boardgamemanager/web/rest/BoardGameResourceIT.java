...
class BoardGameResourceIT {
  ...
  void createBoardGame() throws Exception {
    ...
    assertThat(testBoardGame.getPublicationYear())
      .isEqualTo(DEFAULT_PUBLICATION_YEAR);
    ...
    assertThat(testBoardGame.getCoverContentType())
      .isEqualTo(DEFAULT_COVER_CONTENT_TYPE);
  }
  ...
  void getAllBoardGames() throws Exception {
    ...
    restBoardGameMockMvc
      ...
      .andExpect(
        jsonPath("$.[*].id").value(hasItem(boardGame.getId().intValue()))
      )
      .andExpect(jsonPath("$.[*].title").value(hasItem(DEFAULT_TITLE)))
      .andExpect(
        jsonPath("$.[*].minPlayers").value(hasItem(DEFAULT_MIN_PLAYERS))
      )
      .andExpect(
        jsonPath("$.[*].maxPlayers").value(hasItem(DEFAULT_MAX_PLAYERS))
      )
      .andExpect(
      ...
      .andExpect(
        jsonPath("$.[*].playingTime").value(hasItem(DEFAULT_PLAYING_TIME))
      )
      .andExpect(
  ...
  void getAllBoardGamesWithEagerRelationshipsIsEnabled() throws Exception {
    when(boardGameRepositoryMock.findAllWithEagerRelationships(any()))
    ...
    verify(boardGameRepositoryMock, times(1))
  ...
  void getBoardGame() throws Exception {
    ...
    restBoardGameMockMvc
      ...
      .andExpect(
        jsonPath("$.coverContentType").value(DEFAULT_COVER_CONTENT_TYPE)
      )
      .andExpect(
        jsonPath("$.cover").value(Base64Utils.encodeToString(DEFAULT_COVER))
      );
  }
  ...
  void putExistingBoardGame() throws Exception {
    ...
    assertThat(testBoardGame.getPublicationYear())
      .isEqualTo(UPDATED_PUBLICATION_YEAR);
    ...
    assertThat(testBoardGame.getCoverContentType())
      .isEqualTo(UPDATED_COVER_CONTENT_TYPE);
  }
  ...
  void deleteBoardGame() throws Exception {
    ...
    restBoardGameMockMvc
      .perform(
        delete(ENTITY_API_URL_ID, boardGame.getId())
